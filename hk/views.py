...
def start_sync_products():
    ...
    mongo_db = mapi[mongo['dbname']]
    m_products = mongo_db['products'].find()
    fix_products = ["9b376793-36ae-45b6-9831-02a7362fe92f", "5b672ab0-7fb6-4a04-8fb2-b8eee17e9b43", "28149e68-e092-4572-9cdf-fdd295c2a6a0", "fa845ec8-bef4-4964-bfee-1b05ee47e0b3",
